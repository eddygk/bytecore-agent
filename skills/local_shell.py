...
class LocalShellSkill(BaseSkill):
    ...
    def __init__(self, context):
        ...
        self.allowed_commands = [
            ...
            "git", "python", "pip", "node", "npm", "curl",
            "ps", "top", "df", "du", "whoami", "date"
        ]
        
        # Safety: Define blocked patterns
        self.blocked_patterns = [
            "rm -rf", "del /f", "format", "fdisk",
            "sudo", "su", "chmod 777", "mkfs"
        ]
    ...
    async def _check_command_availability(self, commands: List[str], **kwargs) -> Dict[str, Any]:
